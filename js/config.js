...
export const COLUMN_EXPLANATIONS = {
    ...
    Eigenvector_Centrality:"Eigenvector_Centrality，特徵向量中心性，不只看連結數量，也看連結的對象是否大咖，反映「核心地位」",
    Local_Clustering_Coefficient:"Local_Clustering_Coefficient，一個節點的朋友之間是否互相連結，代表朋友圈密度",
    "Core-periphery_Coreness":"Core-periphery_Coreness，節點在核心—邊陲結構中的核心程度：單一節點有多靠近網路的最核心地帶",
